...
public class ControladorKob1 {
    ...
    public LinkedList<ModeloKob1> Select(String Sql, String Fecha, String PorcentajeDesde, String PorcentajeHasta, Connection con) {
...
//        }
        ...
        try {
            ...
            System.out.println("Error en ControladorKob1 - Select " + e);
        }
...
//            con.close();
    ...
    public StringBuilder ValidarValor(String Cadena1) {
        StringBuilder Cadena = new StringBuilder();
    ...
    public boolean UpdateList_Carlos_2(LinkedList<ModeloKob1> listModeloKob1, Connection con, String Proceso, String FechaA, String PorcentajeDesde, String PorcentajeHasta) throws SQLException {
        boolean resul = false;
...
//            con.close();
    ...
    public boolean UpdateModelo(ModeloKob1 modeloKob1, Connection con) throws SQLException {
        boolean resul = false;
//        ConexionBDMySql conexion = new ConexionBDMySql();
//        Connection con;
//        con = conexion.abrirConexion();
        ...
        try {
            ...
            SQL.setString(40, modeloKob1.getNuevo_Valor_Orden());
            SQL.setString(41, modeloKob1.getMonth());
            //SQL.setInt(42, modeloKob1.getIdArchivo());
            SQL.setString(42, modeloKob1.getFecha());
            SQL.setString(43, modeloKob1.getProduccion());
            SQL.setString(44, modeloKob1.getInventario());
            SQL.setInt(45, modeloKob1.getId());
            if (SQL.executeUpdate() > 0) {
                resul = true;
            }
