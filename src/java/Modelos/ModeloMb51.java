...
public class ModeloMb51 {
    ...
    String Month;
    String Period;
    String Cost_Unit_SAP_en_KG;
    String Material_Type;
    String Profit_Center;
    String link1_Material_Batch;
    String link2_PO_position;
    String Referencia_vendor;
    ...
    String Adicionales_al_CTO_Estandar;
    String Variance;
    String Total_Costos;
    String Unitario_Real;
    String Unitario_Real_adicional_estandar;
    String Unitario_estandar_SAP;
    String Unitario_final_FIFO;
    String Porcentaje_Real_Vs_Estandar;
    ...
    public ModeloMb51(Integer Id, String Plant, String Purchase_order, String Material, String Material_Description, String Batch, String Movement_type, String Movement_Type_Text, String Item, String Quantity, String Qty_in_unit_of_entry, String Unit_of_Entry, String Amt_in_loc_cur, String Currency, String Storage_Location, String Posting_Date, String Document_Date, String Material_Document, String User_Name, String Vendor, String Vendor_Name, String Vendor_Type, String Month, String Period, String Cost_Unit_SAP_en_KG, String Material_Type, String Profit_Center, String link1_Material_Batch, String link2_PO_position, String Referencia_vendor, String TotalQ_ME80FN, String O_Unit_ME80FN, String TotalQ_Porcentaje, String TOTAL_INVOICE_VALUE, String Factura_Value_Unit, String PIR_Porcentaje_del_Costo, String Precio_Unit_moneda_compra, String Moneda, String link3_PO_Item, String Freight, String Dutys, String Arancel, String Total_Costos_Adicionales, String Participac_Adicionales, String Adicionales_al_CTO_Estandar, String Variance, String Total_Costos, String Unitario_Real, String Unitario_Real_adicional_estandar, String Unitario_estandar_SAP, String Unitario_final_FIFO, String Porcentaje_Real_Vs_Estandar, String Porcentaje_fifo_final_vs_Estandar, String Compra_valorada_a_Unit_FIFO, String Variacion_FIFO_vs_Estandar, String NovedadIco, Integer IdArchivo) {
        ...
        this.Month = Month;
        this.Period = Period;
        this.Cost_Unit_SAP_en_KG = Cost_Unit_SAP_en_KG;
        this.Material_Type = Material_Type;
        this.Profit_Center = Profit_Center;
        this.link1_Material_Batch = link1_Material_Batch;
        this.link2_PO_position = link2_PO_position;
        this.Referencia_vendor = Referencia_vendor;
        this.TotalQ_ME80FN = TotalQ_ME80FN;
        this.O_Unit_ME80FN = O_Unit_ME80FN;
        ...
        this.Adicionales_al_CTO_Estandar = Adicionales_al_CTO_Estandar;
        this.Variance = Variance;
        this.Total_Costos = Total_Costos;
        this.Unitario_Real = Unitario_Real;
        this.Unitario_Real_adicional_estandar = Unitario_Real_adicional_estandar;
        this.Unitario_estandar_SAP = Unitario_estandar_SAP;
        this.Unitario_final_FIFO = Unitario_final_FIFO;
        this.Porcentaje_Real_Vs_Estandar = Porcentaje_Real_Vs_Estandar;
    ...
    public String getCost_Unit_SAP_en_KG() {
        return Cost_Unit_SAP_en_KG;
    }

    public void setCost_Unit_SAP_en_KG(String Cost_Unit_SAP_en_KG) {
        this.Cost_Unit_SAP_en_KG = Cost_Unit_SAP_en_KG;
    }
    ...
    public String getLink1_Material_Batch() {
        return link1_Material_Batch;
    }

    public void setLink1_Material_Batch(String link1_Material_Batch) {
        this.link1_Material_Batch = link1_Material_Batch;
    }

    public String getLink2_PO_position() {
        return link2_PO_position;
    }

    public void setLink2_PO_position(String link2_PO_position) {
        this.link2_PO_position = link2_PO_position;
    }

    public String getReferencia_vendor() {
        return Referencia_vendor;
    }

    public void setReferencia_vendor(String Referencia_vendor) {
        this.Referencia_vendor = Referencia_vendor;
    }
    ...
    public String getO_Unit_ME80FN() {
        return O_Unit_ME80FN;
    }

    public void setO_Unit_ME80FN(String O_Unit_ME80FN) {
        this.O_Unit_ME80FN = O_Unit_ME80FN;
    }
    ...
    public String getPIR_Porcentaje_del_Costo() {
        return PIR_Porcentaje_del_Costo;
    }
    ...
    public String getLink3_PO_Item() {
        return link3_PO_Item;
    }

    public void setLink3_PO_Item(String link3_PO_Item) {
        this.link3_PO_Item = link3_PO_Item;
    }
    ...
    public String getAdicionales_al_CTO_Estandar() {
        return Adicionales_al_CTO_Estandar;
    }

    public void setAdicionales_al_CTO_Estandar(String Adicionales_al_CTO_Estandar) {
        this.Adicionales_al_CTO_Estandar = Adicionales_al_CTO_Estandar;
    }
    ...
    public String getUnitario_Real() {
        return Unitario_Real;
    }

    public void setUnitario_Real(String Unitario_Real) {
        this.Unitario_Real = Unitario_Real;
    }

    public String getUnitario_Real_adicional_estandar() {
        return Unitario_Real_adicional_estandar;
    }

    public void setUnitario_Real_adicional_estandar(String Unitario_Real_adicional_estandar) {
        this.Unitario_Real_adicional_estandar = Unitario_Real_adicional_estandar;
    }

    public String getUnitario_estandar_SAP() {
        return Unitario_estandar_SAP;
    }

    public void setUnitario_estandar_SAP(String Unitario_estandar_SAP) {
        this.Unitario_estandar_SAP = Unitario_estandar_SAP;
    }
    ...
    public String getPorcentaje_Real_Vs_Estandar() {
        return Porcentaje_Real_Vs_Estandar;
    }

    public void setPorcentaje_Real_Vs_Estandar(String Porcentaje_Real_Vs_Estandar) {
        this.Porcentaje_Real_Vs_Estandar = Porcentaje_Real_Vs_Estandar;
    }

    public String getPorcentaje_fifo_final_vs_Estandar() {
        return Porcentaje_fifo_final_vs_Estandar;
    }

    public void setPorcentaje_fifo_final_vs_Estandar(String Porcentaje_fifo_final_vs_Estandar) {
        this.Porcentaje_fifo_final_vs_Estandar = Porcentaje_fifo_final_vs_Estandar;
    }

    public String getCompra_valorada_a_Unit_FIFO() {
        return Compra_valorada_a_Unit_FIFO;
    }

    public void setCompra_valorada_a_Unit_FIFO(String Compra_valorada_a_Unit_FIFO) {
        this.Compra_valorada_a_Unit_FIFO = Compra_valorada_a_Unit_FIFO;
    }
