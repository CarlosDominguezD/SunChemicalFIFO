...
<html>
    <head>         
        ...
        <script type="text/javascript" src="Principal/js/jsfifo/ValidacionesGestionCompras.js" ></script> 
    </head>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left input_mask" action="ServletSunchemical" method="POST" name="ComprasJSP" enctype="multipart/form-data" id="IdComprasJSP" >                            
                                ...
                                <div class="text-center" id="botonCargar" align="center">
                                    <div class="col-lg-12" style="text-align: center">                                        
                                        <button type="button" class="btn btn-warning" id="IdAbrirPlano" name="Accion" value="AbrirPlano" >Abrir Plano</button>                                        
                                    </div>                                                            
                                </div>
