                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div id="Principal">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                <select class="form-control" id="IdItemMenu" name="ItemMenu">                                                       
                                                    <%
                                                        ControladorItemMenu controladorItemMenu = new ControladorItemMenu ();
                                                        LinkedList<ModeloItemMenu> listmodeloItemMenu = controladorItemMenu.Read ();                                                        
                                                        for (ModeloItemMenu modeloItemMenu : listmodeloItemMenu)
                                                        {
                                                    %>
                                                    <option value="<%=modeloItemMenu.getId ()%>"><%=modeloItemMenu.getNombre ()%></option> 
                                                    <%
                                                        }
                                                    %>  
                                                </select>
