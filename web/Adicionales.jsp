<%-- 
    ...
    Created on : 7/12/2020, 08:21:27 AM
...
<html>
    <head>        
        ...
        <script type="text/javascript" src="Principal/js/jsfifo/ValidacionesAdicionales.js" ></script> 
    </head>
    <body class="nav-md">
        <%
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div id="Principal">
                                        <div class="row">
                                            ...
                                            <div id="SelectAdicional">
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                    <label for="Adicionaless">Adicionales</label>
                                                    <select class="form-control" id="IdAdicional" name="Mes">                                                                                        
                                                        <option value=0></option>
                                                        <option value="Freight">Freight</option>
                                                        <option value="DUTYS">DUTYS</option>
                                                        <option value="Arancel">Arancel</option>                                                    
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                <label for="Offsetting_acct_no">Valores Offsetting_acct_no</label>
                                                <input type="text" class="form-control" id="Id_Offsetting_acct_no" name="Offsetting_acct_no" required="required">
                                            </div>
