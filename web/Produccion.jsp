        ...
        <div class="right_col" role="main">
            <div class="">            
                ...
                <div class="row">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Descargar Reporte Produccion</h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <form class="form-horizontal form-label-left input_mask" action="ServletSunchemical" method="POST" name="ComprasJSP" enctype="multipart/form-data" id="IdComprasJSP" >                            
                                ...
                                <div class="text-center" id="botonCargar" align="center">
                                    <div class="col-lg-12" style="text-align: center">
                                        <button type="submit" class="btn btn-primary" id="IdGenerarPlano" name="Accion" value="GenerarArchivoProduccion" >Generar Plano</button>                                        
