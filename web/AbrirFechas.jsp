                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left input_mask" action="ServletSunchemical" method="POST" name="ComprasJSP" enctype="multipart/form-data" id="IdComprasJSP" >                            
                                ...
                                <div id="Principal">                                                                                                                                                                         
                                    ...
                                    <div class="row">
                                        <input type="hidden" id="IdFechaAbrir" name="IdFecha">
                                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                            <label for="mes">Mes</label>     
                                            <input type="text" class="form-control" id="IdMesAbrir" name="Mes" required="required" disabled="">
                                        </div>
                                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                            <label for="ano">Año</label>      
                                            <input type="text" class="form-control" id="IdAnoAbrir" name="Amo" required="required" disabled="">
                                        </div>
                                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                            <label for="fase">Fase</label>      
                                            <input type="text" class="form-control" id="IdFaseAbrir" name="fase" required="required" disabled="">
                                        </div>
                                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                            <label for="estado">Estado</label>      
                                            <input type="text" class="form-control" id="IdEstadoAbrir" name="estado" required="required" disabled="">
                                        </div>
                                    </div>
                                </div>
                                <div class="text-center" id="botonCargar" align="center">
                                    <div class="col-lg-12" style="text-align: center">
                                        <button type="button" class="btn btn-primary" id="IdAbrirFecha" name="Accion" value="AbrirFecha" >Abrir Fecha</button>                                                                                
                                    </div>                                                            
                                </div>
